...
const NavBar = () => {
  ...
  return (
    <header className="w-full px-2 py-2 md:px-4 md:py-3 lg:px-7 lg:py-6 bg-white drop-shadow-sm font-mont fixed top-0 left-0">
        <div className="w-full h-full max-w-[1400px] flex items-center justify-between">
        <h1 className="text-[38px] font-bold text-pink-500 font-pacifico leading-[0px]">beMyVal<span className="text-black text-[72px]">.</span></h1>
