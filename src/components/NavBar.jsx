...
const NavBar = () => {
  ...
  return (
    <header className="w-full px-5 py-4 md:px-4 md:py-3 lg:px-10 lg:py-3 lg:pb-6 bg-white drop-shadow-sm font-mont fixed top-0 left-0 z-50">
        ...
        <Link to='will-you-be-my-val' className={`px-5 py-[10px] bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white text-sm md:text-[16px] font-medium rounded-[5px] transition-all duration-200 ease-in-out ${location.pathname === '/will-you-be-my-val' ? 'hidden' : 'block'}`}>Try it out</Link>
