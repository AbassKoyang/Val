...
const BeMyVal = () => {
  ...
  return (
    <section className="w-full h-full grid grid-cols-2 bg-white">
        <div className="col-span-1 h-full flex flex-col items-center justify-center px-3 lg:px-8">
            <h1 className='max-w-[100%] text-center text-6xl text-black font-pacifico'>With every beat of my heart, I ask: will you be my Valentine?</h1>
